...
#
# 本文件为实验性配置文件. 传统google配置文件镜像的是 www.google.com.hk
#   而本文件镜像的是 www.google.com, 区别在于前者不允许关闭"安全搜索"而后者默认关闭
#
# 使用方法:
#   1. 复制本文件到 zmirror 根目录(wsgi.py所在目录), 并重命名为 config.py
#   2. 复制 experimental__custom_func_google.py 到zmirror根目录, 并重命名为 custom_func.py
#   2. 修改 my_host_name 为你自己的域名
#
#
# 警告: 本文件为实验性配置文件, 正常情况下请使用 config_google_and_zhwikipedia.py 这个配置文件
# 警告: 本文件为实验性配置文件, 正常情况下请使用 config_google_and_zhwikipedia.py 这个配置文件
# 警告: 本文件为实验性配置文件, 正常情况下请使用 config_google_and_zhwikipedia.py 这个配置文件
# 警告: 本文件为实验性配置文件, 正常情况下请使用 config_google_and_zhwikipedia.py 这个配置文件
#
